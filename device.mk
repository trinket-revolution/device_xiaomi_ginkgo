...
PRODUCT_COPY_FILES += \
    device/xiaomi/ginkgo/nfc/libnfc-nci.conf:system/etc/libnfc-nci.conf \
    device/xiaomi/ginkgo/nfc/libnfc-nxp.conf:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-nxp.conf
...
# Thermal HAL
PRODUCT_PACKAGES += \
    android.hardware.thermal@2.0-service.ginkgo \
